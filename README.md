...
- 🔁 Coming from an **engineering background** — brought that structured, problem-solving mindset into software
- 💻 Build web apps with **Django**, **React**, **Redux Toolkit**, and **PostgreSQL**
- 🧪 Comfortable across the stack: scalable backends, clean UI, secure REST APIs
- 🚀 Shipped a **production app for a real client** — deployed on VPS with Nginx, Gunicorn, HTTPS & CI/CD
- 🐧 Confident with **Linux**, **Docker**, and **Bash** for dev + deployment workflows
- 📈 Going backend-leaning — deepening **API design, system architecture, and Node/Express**
...
|---|---|---|---|
| [🎬 Jumooh Media Portfolio](https://github.com/AymanCE-SE/pervasion) | Production platform for a real client — bilingual, 500+ monthly visitors, JWT auth, deployed on VPS with Nginx/Gunicorn/CI-CD | Django REST · React · Redux Toolkit · PostgreSQL | [Demo](https://pervasion.vercel.app/) |
| [👨‍💼 Tanfeez Freelancing Platform](https://github.com/AymanCE-SE/Tanfeez-freelancePlatform) | Freelance marketplace — dual roles, project/service proposals, dashboards, JWT auth | Django REST · React · Redux · PostgreSQL | [Demo](https://tanfeez-freelance-platform.vercel.app/) |
...
<p align="center">
  <a href="https://ayman-portfolio-blue.vercel.app/"><img src="https://img.shields.io/badge/Portfolio-36BCF7?style=for-the-badge&logo=vercel&logoColor=white"/></a>
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=AymanCE-SE&style=for-the-badge&color=36BCF7" alt="Profile views" />
</p>
